...
def main():
    ...
    print("="*80)
    print(f"BALANCED OOD-BASED JAILBREAK DETECTION USING KCD - ABLATION: NO PROJECTION ({REQUESTED_MODEL.upper()})")
    print("="*80)
    ...
    # Save results to CSV
    output_path = "results/balanced_kcd_ablate_projection_results.csv"
    ...
    print("- Results saved to: results/balanced_kcd_ablate_projection_results.csv")
