...
class FeatureCache:
    ...
    def save(
        ...
        sidecar = {
            k: v for k, v in cache_data.items() if k not in ("hidden_states", "labels")
        }
    ...
    def get_cache_entry(
        ...
        for file in os.listdir(self.cache_dir):
            ...
            if (
                ...
                and meta.get("experiment_name") != experiment_name
            ):
                continue
        ...
        for file in os.listdir(self.cache_dir):
            ...
            if (
                ...
                and cache_data.get("dataset_name") != dataset_name
            ):
                continue
            ...
            if (
                ...
                and cache_data.get("dataset_size") != dataset_size
            ):
                continue
            if (
                experiment_name is not None
                and cache_data.get("experiment_name") != experiment_name
            ):
                continue
    ...
    def list_cache_files(self):
            ...
            if file.endswith(".pkl"):
                ...
                try:
                    ...
                    cache_info = {
                        ...
                        "processed_samples": cache_data.get("metadata", {}).get(
        ...
        if cache_files:
            ...
            print("-" * 120)
            print(
                f"{'Filename':<50} {'Size(MB)':<10} {'Dataset':<20} {'Layers':<12} {'Samples':<10} {'Experiment':<15}"
            )
            print("-" * 120)
            for info in cache_files:
                print(
                    f"{info['filename']:<50} {info['size_mb']:<10.1f} {info['dataset_name']:<20} "
